                            ...
                            <div class="carousel-item active">
                                <div class="  d-flex justify-content-evenly ms-5 ps-5 my-5 float-lg-row" id="ini">
                                    <ul class="list-group col-sm-4 offset-sm-4 " id="gal">
                                        <li> <img src={{ url('img/contoh1.jpg') }} class="rounded float-start img-fluid"
                                                alt="..." " ></li>
                        <li> <img src={{ url('img/contoh1.jpg') }} class="rounded float-start img-fluid" alt="..." ">
                                        </li>
                                    </ul>
                                    <ul class="list-group col-sm-4 offset-sm-4 " id="gal">
                                        <li> <img src={{ url('img/contoh2.jpg') }} class="rounded float-start img-fluid"
                                                alt="..." " ></li>
                        <li> <img src={{ url('img/contoh2.jpg') }} class="rounded float-start img-fluid" alt="..." ">
                                        </li>
                                    </ul>
