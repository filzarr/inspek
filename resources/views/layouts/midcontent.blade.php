<div class="row mt-5 pt-3  pb-3   h-auto col-xl-5 col-xs-12" style="background-color: #ffffff" id="mid" >
    ...
    <div class=" py-5">
      <div class="card mx-3 mb-3 border-0 pb-5"  class="card">
        <div class="row ">
          <div class="col-md-4">
      ...
      <div class="card mb-3 mx-3 mt-3 border-0 py-5"  class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img/contoh5.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
      ...
      <div class="card mb-3 mx-3 mt-3 border-0 py-5"  class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img/contoh3.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
      ...
      <div class="card mb-3 mx-3 mt-3 border-0 py-5"  class="card">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="img/contoh4.jpg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">Card title</h5>
